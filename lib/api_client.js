...
(function() {
  ...
  ApiClient = (function() {
    ...
    function ApiClient(options) {
      ...
      each(options.stubs || [], function(stub) {
        return _this.stub_request.apply(_this, stub);
      });
    }
    ...
    ApiClient.prototype.stub_request = function(uriRegex, err, response, body) {
    ...
    ApiClient.prototype.get = function(params, headers, cb) {
      ...
      stub = find(this.stubs(), function(stub) {
        return stub[0].test(request_opts.uri);
      });
      if (stub) {
        if (cb) {
